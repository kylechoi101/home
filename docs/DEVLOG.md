...
- "Equity Research" renamed Finance Research; "Tech Sector Analysis — Coming Soon" placeholder removed.
- "Academic Excellence" renamed Education; GPA tiles now show two decimals (3.76 / 3.63) instead of rounding up.
- GitHub, LinkedIn, blog and resume links added to hero and footer.
- Thumbnails resized to 800–900px JPEG (was 8–10 MB each; now 50–210 KB). Unused 8 MB `HMM.jpg`, `finance-thumb.jpg`, `meals-thumb.jpg` removed.
- `llms.txt` rewritten to match.
- Verified with headless Chromium at 1280 and 390 px: no console errors, no horizontal scroll, all images load.
